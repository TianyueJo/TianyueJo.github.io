...
\begin{document}
    ...
    \section{Education}
        ...
        \begin{twocolentry}{
            ...
            \textit{Ph.D. in Civil and Environmental Engineering; Advisor: \href{https://www.wucathy.com/}{\textcolor{blue}{Prof. Cathy Wu}}; GPA:\textbf{5.0/5.0} }\end{twocolentry}
        \vspace{0.10 cm}
...
Learning [\href{https://ojs.aaai.org/index.php/AAAI/article/view/40137}{\textcolor{magenta}{paper}}] [\href{https://mit-wu-lab.github.io/SD-MBTL/}{\textcolor{magenta}{website}}] [\href{https://github.com/mit-wu-lab/SD-MBTL}{\textcolor{magenta}{code}}]}\\
    ...
    \end{twocolentry}
    \begin{twocolentry}{}
         \textit{Undergraduate Research Assistant, Supervised by \href{https://www.wucathy.com/}{\textcolor{blue}{Prof. Cathy Wu}}, MIT LIDS}
    \end{twocolentry}
...
theoretical performance compared to LinUCB.
    ...
    \begin{twocolentry}{
        ...
        \textit{Teaching Assistant, \href{https://web.mit.edu/6.7920/www/index.html}{\textcolor{blue}{6.7920 Reinforcement Learning: Foundations and Methods}}}
    \end{twocolentry}
    \begin{highlights}
        \item Instructors: \href{https://www.wucathy.com/}{\textcolor{blue}{Prof. Cathy Wu}}, Prof. Munther A. Dahleh
    \end{highlights}
